...
[Authorize(BookStorePermissions.Donem.Default)]
public class DonemAppService : BookStoreAppService, IDonemAppService
{
    ...
    [Authorize(BookStorePermissions.Donem.Create)]
    ...
    [Authorize(BookStorePermissions.Donem.Update)]
    ...
    [Authorize(BookStorePermissions.Donem.Delete)]
