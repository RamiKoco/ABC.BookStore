...
[Authorize(BookStorePermissions.OzelKod.Default)]
public class OzelKodAppService : BookStoreAppService, IOzelKodAppService
{
    ...
    [Authorize(BookStorePermissions.OzelKod.Create)]
    ...
    [Authorize(BookStorePermissions.OzelKod.Update)]
    ...
    [Authorize(BookStorePermissions.OzelKod.Delete)]
