...
public class StokHareketAppService: BookStoreAppService, IStokHareketAppService
{
    ...
    public virtual Task<SelectFaturaHareketDto> UpdateAsync(Guid id, FaturaHareketDto input) => throw new NotImplementedException();
