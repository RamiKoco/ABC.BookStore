...
[Authorize(BookStorePermissions.Sube.Default)]
public class SubeAppService : BookStoreAppService, ISubeAppService
{
    ...
    [Authorize(BookStorePermissions.Sube.Create)]
    ...
    [Authorize(BookStorePermissions.Sube.Update)]
    ...
    [Authorize(BookStorePermissions.Sube.Delete)]
