...
public class MasrafManager : DomainService
{
    ...
    public async Task CheckUpdateAsync(Guid id, string kod, Masraflar.Masraf entity,
        Guid? birimId, 
        Guid? ozelKod1Id, 
        Guid? ozelKod2Id,
        Guid? ozelKod3Id,
        ...
        Guid? ozelKod5Id)
    {
        ...
        await _ozelKodRepository.EntityAnyAsync(ozelKod3Id, OzelKodTuru.OzelKod3,
           KartTuru.Masraf, entity.OzelKod3Id != ozelKod3Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod4Id, OzelKodTuru.OzelKod4,
            KartTuru.Masraf, entity.OzelKod4Id != ozelKod4Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod5Id, OzelKodTuru.OzelKod5,
            KartTuru.Masraf, entity.OzelKod5Id != ozelKod5Id);
    }
