...
public class DepoManager : DomainService
{
    ...
    public async Task CheckUpdateAsync(Guid id, string kod, Depolar.Depo entity,
        Guid? ozelKod1Id, 
        Guid? ozelKod2Id,
        Guid? ozelKod3Id,
        Guid? ozelKod4Id,
        Guid? ozelKod5Id)
    {
        ...
        await _ozelKodRepository.EntityAnyAsync(ozelKod3Id, OzelKodTuru.OzelKod3,
           KartTuru.Depo, entity.OzelKod3Id != ozelKod3Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod4Id, OzelKodTuru.OzelKod4,
            KartTuru.Depo, entity.OzelKod4Id != ozelKod4Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod5Id, OzelKodTuru.OzelKod5,
            KartTuru.Depo, entity.OzelKod5Id != ozelKod5Id);
    }
