...
public class KasaManager : DomainService
{
    ...
    public async Task CheckUpdateAsync(Guid id, string kod, Kasalar.Kasa entity,
        Guid? ozelKod1Id, 
        Guid? ozelKod2Id,
        Guid? ozelKod3Id,
        Guid? ozelKod4Id,
        Guid? ozelKod5Id)
    {
        ...
        await _ozelKodRepository.EntityAnyAsync(ozelKod3Id, OzelKodTuru.OzelKod3,
            KartTuru.Kasa, entity.OzelKod3Id != ozelKod3Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod4Id, OzelKodTuru.OzelKod4,
            KartTuru.Kasa, entity.OzelKod4Id != ozelKod4Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod5Id, OzelKodTuru.OzelKod5,
            KartTuru.Kasa, entity.OzelKod5Id != ozelKod5Id);
    }
