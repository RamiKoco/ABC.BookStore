...
public class MakbuzManager : DomainService
{
    ...
    public async Task CheckCreateAsync(string makbuzNo, MakbuzTuru makbuzTuru, Guid? adresId, Guid? cariId,
        Guid? kasaId, 
        Guid? bankaHesapId, 
        Guid? ozelKod1Id, 
        Guid? ozelKod2Id,
    ...
    public async Task CheckUpdateAsync(Guid id, string makbuzNo, 
        Makbuz entity,
        Guid? adresId, 
        Guid? cariId, 
        Guid? kasaId, 
        ...
        Guid? ozelKod5Id)
    {
        ...
        await _ozelKodRepository.EntityAnyAsync(ozelKod3Id, OzelKodTuru.OzelKod3,
            KartTuru.Makbuz, entity.OzelKod3Id != ozelKod3Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod4Id, OzelKodTuru.OzelKod4,
            KartTuru.Makbuz, entity.OzelKod4Id != ozelKod4Id);

        await _ozelKodRepository.EntityAnyAsync(ozelKod5Id, OzelKodTuru.OzelKod5,
            KartTuru.Makbuz, entity.OzelKod5Id != ozelKod5Id);
    }
}