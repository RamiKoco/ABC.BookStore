...
namespace ABC.BookStore.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // React SPA Client
        var reactClientId = configurationSection["BookStore_React:ClientId"];
        if (!reactClientId.IsNullOrWhiteSpace())
        {
            var reactRootUrl = configurationSection["BookStore_React:RootUrl"]?.TrimEnd('/');
            ...
            await CreateApplicationAsync(
                ...
                scopes: commonScopes,
                redirectUri: $"{reactRootUrl}/callback",
                postLogoutRedirectUri: $"{reactRootUrl}",
