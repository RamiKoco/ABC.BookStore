...
public class EfCoreCommonRepository<TEntity> : EfCoreRepository<BookStoreDbContext, TEntity, Guid>,
    ICommonRepository<TEntity> where TEntity : class, IEntity<Guid>
{
    public EfCoreCommonRepository(IDbContextProvider<BookStoreDbContext> dbContextProvider)
